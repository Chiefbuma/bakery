  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground font-medium">WhiskeDelights Artisanal Bakery • Management Portal</p>
      </div>
        ...
        <Card className="lg:col-span-2 border-none shadow-sm overflow-hidden">
          <CardHeader className="bg-stone-900 text-white flex flex-row items-center justify-between">
            ...
            <Link href="/admin/portal/orders">
              <Badge variant="outline" className="text-white border-white/20 hover:bg-white/10 cursor-pointer">Full Ledger</Badge>
            </Link>
          </CardHeader>
