        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground font-medium">Access Management • 5 Records Per Page</p>
                </div>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>Add a new staff member to the WhiskeDelights portal.</DialogDescription>
                    </DialogHeader>
